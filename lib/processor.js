...
module.exports = function (proto) {
  ...
  proto.kill = function (signal) {
    ...
    /**
   * Get current ffmpeg process Id, if any
   *
   * @method FfmpegCommand#getPid
   * @category Processing
   *
   * @return Number
   */
     proto.getPid = function () {
      if (!this.ffmpegProc) {
        this.logger.warn('No running ffmpeg process, cannot get pid');
        return 0
      } else {
        return this.ffmpegProc.pid
      }
    };
};
